...
public function cetak_kuisioner()
    {
        ...
        $data['cetak_kuisioner'] = $this->db->query("SELECT tb_data_kuisioner.id_data_kuisioner, tb_data_kuisioner.soal_kuisioner, tb_jawaban_kuisioner.id_jawaban_kuisioner,tb_jawaban_kuisioner.jawaban, tb_jawaban_kuisioner.nip_nik,  tb_jawaban_kuisioner.id_perusahaan FROM `tb_data_kuisioner` 
			JOIN tb_jenis_kuisioner ON tb_data_kuisioner.id_jenis_kuisioner = tb_jenis_kuisioner.id_jenis_kuisioner 
			JOIN tb_jawaban_kuisioner ON tb_jawaban_kuisioner.id_data_kuisioner=tb_data_kuisioner.id_data_kuisioner WHERE tb_jawaban_kuisioner.id_perusahaan='$id_perusahaan ' ORDER BY tb_data_kuisioner.id_data_kuisioner ASC");
