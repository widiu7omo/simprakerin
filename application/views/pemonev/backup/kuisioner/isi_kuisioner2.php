  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Isi Data Kuisioner</li>
      </ol>
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <form class="form-horizontal" method="post" action="<?php echo site_url()?>pemonev/kuisioner/insert_isi_kuisioner" enctype="multipart/form-data">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-9 col-md-10 col-sm-8 col-xs-7">
                  <div class="form-group">
                    <div class="form-line">
                      <input type="text" hidden="" name="nip_nik" value="<?php echo $this->session->userdata('nip'); ?>">
                      <input type="text" class="form-control" name="nama_pegawai" value="<?php echo $this->session->userdata('nama_pegawai'); ?>" readonly>
                    </div>
                  </div>
                </div>
              </div>
