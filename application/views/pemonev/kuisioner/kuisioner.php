              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <?php
                      $query = $this->db->query("SELECT tb_perusahaan.nama_perusahaan, tb_perusahaan.id_perusahaan, tb_monev.status FROM tb_monev JOIN tb_perusahaan ON tb_monev.id_perusahaan = tb_perusahaan.id_perusahaan WHERE tb_monev.no_surat = '001/PL40/KP/2019'");
                      foreach ($query->result() as $data):
