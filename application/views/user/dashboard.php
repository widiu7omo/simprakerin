	...
	<nav class="sidenav navbar navbar-vertical fixed-left navbar-expand-xs navbar-light bg-white" id="sidenav-main">
		<div class="scroll-wrapper scrollbar-inner" style="position: relative;">
			<div class="scrollbar-inner scroll-content scroll-scrolly_visible"
				style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 505px;">
				<!-- Brand -->
							...
							<li class="nav-item">
								...
								<div class="collapse" id="navbar-components">
									<ul class="nav nav-sm flex-column">
										...
										<li class="nav-item">
											<a href="../../pages/components/typography.html"
			...
			<div class="scroll-element scroll-y scroll-scrolly_visible">
				<div class="scroll-element_outer">
					<div class="scroll-element_size"></div>
					<div class="scroll-element_track"></div>
					<div class="scroll-bar" style="height: 334px; top: 0px;"></div>
				</div>
			</div>
		</div>
	</nav>
					...
					<div class="card bg-default">
						...
						<div class="card-body">
							...
							<div class="chart">
								...
								<!-- Chart wrapper -->
								<canvas id="chart-sales-dark" class="chart-canvas chartjs-render-monitor" width="760"
									height="350" style="display: block; width: 760px; height: 350px;"></canvas>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="chart">
								...
								<canvas id="chart-bars" class="chart-canvas chartjs-render-monitor" width="760"
									height="350" style="display: block; width: 760px; height: 350px;"></canvas>
							</div>
						</div>
					</div>
