<?php
foreach ($data_soal_kuesioner->result() as $data):
                  ...
                  <div class="form-group">
                    <div class="form-line">
                      <select id="nip_nik" name="nip_nik" class="form-control" required>
                        ...
                        <?php 
                          $data_monev = $this->db->query("SELECT * FROM tb_pegawai");
                          foreach ($data_monev->result() as $key2): ?>
                          <option <?php if($nip_nik == "$key2->nip_nik"){echo 'selected=""'; };?> value="<?php echo $key2->nip_nik;?>"><?php echo $key2->nama_pegawai;?></option>
                          <?php endforeach;?>
                      </select>
                    </div>
                  </div>
              ...
              <div class="row clearfix">
                ...
                <div class="col-lg-9 col-md-10 col-sm-8 col-xs-7">
                  <div class="form-group">
                    <div class="form-line">
                      <?php 
                          $data_perusahaan = $this->db->query("SELECT * FROM tb_perusahaan WHERE id_perusahaan='$id_perusahaan'");
                          foreach ($data_perusahaan->result() as $key3):
                          $id_perusahaan = $key3->id_perusahaan;
                          $nama_perusahaan = $key3->nama_perusahaan;
                          endforeach;?>
                      <input type="text" readonly="" class="form-control" name="nama_perusahaan" value="<?php echo $nama_perusahaan; ?>">
