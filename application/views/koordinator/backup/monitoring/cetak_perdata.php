...
<?php
  $query2 = $this->db->query("SELECT tb_pegawai.nama_pegawai, tb_pegawai.id_jabatan, tb_pangkat_golongan.nama_jabatan, tb_pegawai.nip_nik FROM tb_pegawai LEFT JOIN tb_monev ON tb_monev.nip_nik = tb_pegawai.nip_nik JOIN tb_pangkat_golongan ON tb_pangkat_golongan.id_jabatan=tb_pegawai.id_jabatan WHERE tb_monev.no_surat = '$no_surat'");
  $no2 = 1;
...
?>
 ...
 <tr style='mso-yfti-irow:1;height:36.0pt'>
  ...
  margin-bottom:.0001pt'><?php echo $data2->nama_jabatan; ?> </p>
  </td>

  <td style='border-top:none;border-left:none;border-bottom:solid black 1.0pt;
  border-right:solid black 1.0pt;padding:.75pt .75pt .75pt .75pt;height:36.0pt'>
  <p style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;margin-left:10.0pt;
  margin-bottom:.0001pt'><?php echo $data2->id_jabatan; ?> </p>
  </td>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width="100%"
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:13.5pt'>
  ...
  <span class=SpellE>Laut</span>, <?php echo date("d-D-Y")?><o:p></o:p></span></p>
